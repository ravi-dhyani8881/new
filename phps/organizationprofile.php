...
<tr class="textBoxTable">
    ...
    if (isset($_POST['action'])) {
        if ($_POST['action'] == 'Save') {
            ...
            if ($num_rows == 0) {
                mysql_query("INSERT INTO organization (account_id, org_name , WEBSITE_URL , ORG_EMAIL) VALUES ('$account_id','$orgname' , '$web_url' ,'$email' )");
            } else {

                mysql_query("update organization set account_id='$account_id', org_name='$orgname' , WEBSITE_URL='$web_url' , ORG_EMAIL='$email'  WHERE account_id = '$account_id' ");
            }
